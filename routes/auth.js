...
const {getEventsController}=require('../controllers/eventsController')
...
auth.post('/sigin',validationSignIn,isValid,authSignin)

auth.post('/event',eventsController) 

auth.get('/getevents',getEventsController) 
